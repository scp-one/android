...
import com.greenknightlabs.scp_001.app.fragments.DependenciesFragment
import com.greenknightlabs.scp_001.app.fragments.PageFragment
import com.greenknightlabs.scp_001.app.interfaces.BindableView
import com.greenknightlabs.scp_001.app.layouts.ListOptionSectionLayout
...
import com.greenknightlabs.scp_001.users.layouts.ProfileFragmentHeaderLayout
import com.greenknightlabs.scp_001.users.models.User
import com.greenknightlabs.scp_001.users.view_models.ProfileFragmentViewModel
    ...
    ProfileFragmentHeaderLayout.Listener
{
    ...
    private val sections = listOf(
        ...
        ListOptionSection(
            "SUPPORT",
            listOf(
                ListOption("Tip Jar", R.drawable.ic_savings) {
        ...
        ListOptionSection(
            ...
            listOf(
                ...
                ListOption("Terms of Service", R.drawable.ic_subject) {
                    // TODO: replace with a global constant
